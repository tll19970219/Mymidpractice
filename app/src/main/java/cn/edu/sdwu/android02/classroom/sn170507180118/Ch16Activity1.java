...
private TextureView textureView;
    ...
    private ImageReader imageReader;//接受相机生成的静态图像
   public void takephoto(View view){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //实例化stateCallback，它用来当打开相机时，执行的方法（便于会话的创建）
                   ...
                   captureRequestBuilder.addTarget(surface);//指定视频输出的位置
                    ...
                    cameraDevice.createCaptureSession(Arrays.asList(surface,imageReader.getSurface()), new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            //会话创建完成后，我们在参数中得到会话的对象
                           //开始显示相机的预览
                           Ch16Activity1.this.cameraCaptureSession=cameraCaptureSession;
                            try {
                                previewRequest=captureRequestBuilder.build();
                                cameraCaptureSession.setRepeatingRequest(previewRequest,null,null);//在会话中发出重复请求，进行预览(捕获连续的图像)
                            } catch (Exception e) {
                                Log.e(Ch16Activity1.class.toString(),e.toString());
                            }
   ...
   public void sms(View view){
    ...
    private void sendSms(){
        ...
        smsManager.sendTextMessage("13305311234","13111111111","short manager test",null,null);
    }
    private void callPhone(){
        Intent intent=new Intent(Intent.ACTION_CALL, Uri.parse("tel://13305311234"));
