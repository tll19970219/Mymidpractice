...
//计数的方法
    public void counter(View view){
        count++;
        Log.i(Ch10Activity1.this.toString(),"counter:"+count);
    }
    @Override
    protected void onSaveInstanceState(Bundle outState) {
       //使用本方法保存一些界面信息
        ...
        Log.i(Ch10Activity1.this.toString(),"onSaveInstanceState");
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        Log.i(Ch10Activity1.this.toString(),"onRestoreInstanceState");
    }
