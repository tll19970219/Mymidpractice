...
private EditText ip;
    ...
    //读取raw中readme.txt文件的内容
    public void readRaw(View view){
        Resources resources=getResources();
        InputStream inputStream=resources.openRawResource(R.raw.raedme);
        try {
    ...
    private void writeExternal(String content){
        ...
        //创建File对象
        File file=new File(Environment.getExternalStorageDirectory(),"abcda.txt");//构造方法中，提供文件所在的目录名和文件名
